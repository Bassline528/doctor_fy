...
import 'package:doctor_fy/features/user/data/entities/profile_entity.dart';
  ...
  void initState() {
    ...
    _messagesStream = supabase
        ...
        .map(
          (maps) => maps
              .map(
                (map) => Message.fromJson(map, myUserId: myUserId),
              )
              .toList(),
        );
    super.initState();
...
class _ChatBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var chatContents = <Widget>[
      ...
      Text(message.createdAt.toIso8601String()),
